...
- Parallel 3-form: ∇φ = 0
- **Non-zero torsion**: |dφ| ≈ 0.0164, |d★φ| ≈ 0.0140 (measured from numerical reconstruction)
...
- ∇φ = 0 (parallel)
- **dφ ≠ 0** (small non-closure: |dφ| ≈ 0.0164)
- **d★φ ≠ 0** (small dual non-closure: |d★φ| ≈ 0.0140)

**Note**: Ideal G₂ holonomy requires dφ = 0 and d★φ = 0 (torsion-free). However, physical interactions require small but non-zero torsion. The values above represent the measured torsion from numerical metric reconstruction (see Supplement G for details).
...
- G₂ holonomy: ∇φ = 0
- **Non-zero torsion**: |dφ| ≈ 0.0164, |d★φ| ≈ 0.0140 (see Supplement G)
- Ricci-flat: Ric(g) = 0 (approximately, with small torsion corrections)
