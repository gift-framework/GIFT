...
Full details of the PINN architecture, training protocol, and complete analysis are presented in a companion paper (``An Explicit Approximate $\Gtwo$ Metric on a Compact TCS 7-Manifold with Certified Torsion-Free Completion,'' DOI: 10.5281/zenodo.18860358). For related neural approaches to $\Gtwo$ structures on contact Calabi--Yau 7-manifolds, see~\cite{heyes2025}.
...
\begin{itemize}
\item Paper and data: \url{https://doi.org/10.5281/zenodo.18837071} (framework), \url{https://doi.org/10.5281/zenodo.18860358} (explicit $\Gtwo$ metric)
