...
Full details of the PINN architecture, training protocol, and complete analysis are presented in a companion paper (``A Numerical Candidate for a Torsion-Free $\Gtwo$ Structure on a Compact TCS 7-Manifold,'' DOI: 10.5281/zenodo.18837071). For related neural approaches to $\Gtwo$ structures on contact Calabi--Yau 7-manifolds, see~\cite{heyes2025}.
...
\begin{itemize}
\item Paper and data: \url{https://doi.org/10.5281/zenodo.18837071}
