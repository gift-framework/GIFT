...
\topomark & Direct consequence of manifold structure, no empirical input \\
\derived & Computed from \proven/\topomark{} relations \\
...
\textbf{Status}: \topomark{} $\blacksquare$
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item $\det(g) = 65/32 = 2.03125$: $\Kseven$ metric determinant (\topomark)
        \item $\kappa_T = 1/61$: Torsion magnitude (\topomark)
...
Experimental (NuFIT 6.0) & $33.41° \pm 0.75°$ \\
Deviation & 0.027\% \\
\bottomrule
\end{tabular}
\end{center}
...
Experimental (NuFIT 6.0) & $8.54° \pm 0.12°$ \\
Deviation & 0.36\% \\
\bottomrule
\end{tabular}
\end{center}
...
Experimental (NuFIT 6.0) & $49.3° \pm 1.0°$ \\
Deviation & 0.22\% \\
\bottomrule
\end{tabular}
\end{center}
...
\topomark & 12 & Direct topological derivation \\
