---
title: GiftPy pour les géomètres
---
...
Pour la construction spécifique dans K₇, les blocs de construction donnent les nombres de Betti calculés via Mayer-Vietoris :
...
Les termes de torsion poussent vers la condition sans torsion. La contrainte de déterminant fixe la forme de volume à une cible spécifiée (65/32 dans l'application K₇). Le terme de positivité garantit que la métrique induite g(φ) reste définie positive.
...
**Bornes TCS standards** : à noter que les constructions TCS typiques donnent b₂ ≤ 9. Le K₇ de K₇ avec b₂ = 21 emploie soit des blocs de construction non standards, soit doit être compris via la caractérisation variationnelle plutôt que via le recollement TCS explicite.
...
*`gift_core` fait partie du cadre K₇ v3.3. Pour l'application physique, voir l'[article principal](Paper-Main-Framework.html).*
