...
- Precision of experimental agreement (v3.4: 95 observables in 4 types: Type I 0.99% mean dev on 33 obs, Type II 0.17% on 19 obs, Type III 3.44% on 21 obs; 11 exact matches, 53 within 1%; NuFIT 6.1 / PDG 2024 / Planck 2018 / CODATA 2022)
...
Mean deviation from experiment (v3.4, 95 observables): **Type I 0.99%** on 33 dimensionless ratios, **Type II 0.17%** on 19 one-step physical extractions, **Type III 3.44%** on 21 multi-step dynamical chains; 11 exact matches (<0.01%), 53 within 1% (NuFIT 6.1 / PDG 2024 / Planck 2018 / CODATA 2022).
...
**High-precision** (<0.5%):
- Complete neutrino sector: mean 0.24% (v3.3.24 baseline)
- Gauge couplings: mean 0.03%
- CKM matrix: mean 0.11%

**Overall (v3.4, 95-observable dataset)**: Type I 0.99% on 33 dimensionless ratios, Type II 0.17% on 19 obs, Type III 3.44% on 21 obs; 11 exact (<0.01%), 53 within 1%. The legacy v3.3.24 figure (0.24% across 32 obs, 0.57% incl. δ_CP) is preserved per-sector for traceability.
