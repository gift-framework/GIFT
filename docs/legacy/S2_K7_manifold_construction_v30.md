...
│                                                             │
│  SORRY REDUCTION: v3.0(4) → v3.0(3) → v3.0(0)             │
│                                                             │
...
- SORRY reduction: v3.0(4) → v3.0(3) → v3.0(0 core SORRY) [PROVEN]
