...
### 1.3.0 Torsion from Non-Closure
...
## 3.0 Conservation Laws

### 3.0.1 Energy Conservation

$$E = g_{ij} \frac{dx^i}{d\lambda} \frac{dx^j}{d\lambda} = \text{const}$$

**Status**: PROVEN

### 3.0.2 Topological Charges
...
$$\frac{\dot{\alpha}}{\alpha} \sim 3.0 \times 10^{-18} \times 0.008 \times (0.015)^2 \approx 10^{-16} \text{ yr}^{-1}$$
