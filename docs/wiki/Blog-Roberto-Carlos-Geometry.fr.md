---
title: "Blog : La géométrie de l'impossible"
layout: default
---
...
- La vitesse de rotation (à quelle vitesse le ballon tourne)
- La vitesse de translation (à quelle vitesse le ballon avance)
- La densité de l'air (altitude, humidité, température)
- La texture de la surface (les panneaux du ballon, l'usure)
- L'angle de frappe (où exactement le pied touche le ballon)
- L'accompagnement (la trajectoire du pied après contact)
...
- Où Barthez se tenait (et où il s'attendait à voir le tir)
- La hauteur et la position du mur
- L'état psychologique de tous ceux qui regardaient
...
- Partir de 35 mètres du but
- Contourner un mur
- Tromper un gardien de classe mondiale
...
Barthez ne pouvait pas percevoir la rotation en temps réel. Il en a vu l'effet (la trajectoire incurvée) mais à ce moment-là, il était trop tard pour réagir. L'information qui déterminait le résultat était *là*, dans le ballon en rotation, mais elle était encodée dans une variable difficile d'accès.
...
- Il y a une structure cachée (rotation / géométrie)
- Elle encode de l'information qui détermine les résultats (trajectoire / constantes)
