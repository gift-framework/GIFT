...
> **v3.5 update.** Canonical content lives in [`GIFT_v3.5_S1_foundations.md`](https://github.com/Arithmon/K7/blob/main/publications/papers/markdown/k7_framework_3_5_S1_foundations.md). The v3.5 LaTeX/PDF is being recompiled with the K₇ branding template.
