...
**Related documentation**: [S1: Foundations](Paper-S1-Foundations.html)

---

*`gift_core` is part of the GIFT Framework v3.3. For the physics application, see the [main paper](Paper-Main-Framework.html).*
