...
@software{gift_framework_v34,
  ...
  version = {3.4.19},
  license = {MIT},
  note    = {95 observables, 0.39\% mean deviation on 35 Type I relations (PDG 2024 / NuFIT 6.0), 213 conjuncts certified in Lean 4, 4 main-chain axioms, Donaldson direct chain closed (5-layer Wirtinger certificate)}
}
```
...
```
de La Fournière, B. (2026). GIFT Framework v3.4: Geometric Information Field Theory (Version 3.4.19) [Software]. GitHub. https://github.com/gift-framework/GIFT
```

### Chicago Style

```
de La Fournière, Brieuc. "GIFT Framework v3.4: Geometric Information Field Theory." Version 3.4.19. GitHub, 2026. https://github.com/gift-framework/GIFT.
```
...
## Framework v3.4 Papers (Zenodo, PDF)
...
@misc{gift_main_v34,
  ...
  url          = {https://github.com/gift-framework/GIFT/raw/main/publications/papers/pdf/gift_3.4_main.pdf}
}
```
...
@misc{gift_s1_foundations_v34,
  ...
  year         = {2026},
  month        = {May},
  howpublished = {GIFT Framework v3.4, Supplement S1, 27 pp.},
  doi          = {10.5281/zenodo.20070101},
  url          = {https://github.com/gift-framework/GIFT/raw/main/publications/papers/pdf/gift_3.4_S1.pdf}
}
```
...
@misc{gift_s2_derivations_v34,
  ...
  year         = {2026},
  month        = {May},
  howpublished = {GIFT Framework v3.4, Supplement S2, 42 pp.},
  doi          = {10.5281/zenodo.20070101},
  url          = {https://github.com/gift-framework/GIFT/raw/main/publications/papers/pdf/gift_3.4_S2.pdf}
}
```
...
@misc{gift_s3_observables_v34,
  ...
  year         = {2026},
  month        = {May},
  howpublished = {GIFT Framework v3.4, Supplement S3, 10 pp.},
  doi          = {10.5281/zenodo.20070101},
  url          = {https://github.com/gift-framework/GIFT/raw/main/publications/papers/pdf/gift_3.4_S3.pdf}
}
```
